import { testimonials } from '@/data/en/testimonials'
import Image from 'next/image'
import React from 'react'

function Testimonials() {
  return (
    <section class="py-10 container mx-auto sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div  class="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
          {
            testimonials.map((e,i) => (
                <div key={i} class="overflow-hidden bg-white rounded-md shadow">
                    <div class="px-8 py-12">
                        <div class="relative w-24 h-24 mx-auto">
                            <Image width={500} height={500}  class="relative object-cover w-24 h-24 mx-auto rounded-full" src={e.img} alt="" />
                        ...
                        <blockquote class="mt-7 p-0 border-0">
                            <p class="text-lg text-black">{e.testimony}</p>
                        </blockquote>
                        <p class="text-base font-semibold tex-tblack mt-9">{e.name}</p>
                        <p class="mt-1 text-base text-gray-600">{e.job}</p>
                    </div>
                </div>
            ))
        }
