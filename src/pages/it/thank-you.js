    ...
    <>
      ...
      <div className="flex mt-32 container mx-auto w-full gap-10 md:gap-0 flex-col md:flex-row">
        ...
        <div className="w-full md:w-3/6 px-2 sm:px-10 flex flex-col gap-4  justify-center">
          ...
          <p className="">
            {" "}
            Siamo veramente grati per averci contattato. La tua richiesta è
            importante per noi e apprezziamo l&apos;opportunità di assisterti. Il
            nostro team dedicato sta lavorando con diligenza per offrirti il
