    ...
    <>
      ...
      <div className="flex mt-32 container mx-auto w-full gap-10 md:gap-0 flex-col md:flex-row">
        ...
        <div className="w-full md:w-3/6 px-2 sm:px-10 flex flex-col gap-4  justify-center">
          ...
          <p className="">
            {" "}
            Nous vous sommes vraiment reconnaissants d&lsquo;avoir pris contact avec
            nous. Votre demande est importante à nos yeux, et nous sommes
            reconnaissants de l&lsquo;opportunité de vous aider. Notre équipe dévouée
            travaille avec diligence pour vous offrir le meilleur soutien
            possible.
          </p>
          <Link href={lang + "/"}>
